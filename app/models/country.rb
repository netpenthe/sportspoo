class Country < ActiveRecord::Base
  ...
  has_many :upcoming_events, :source => :events, :through=>:leagues, :conditions=> proc {"start_date > '#{Time.now.utc - Constants::RUNNING_EVENTS_HOURS.hour}' and priority=0"}, :order=>'start_date', :limit=>100
